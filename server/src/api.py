from external_libraries.flask.flask import Flask, request, jsonify
from external_libraries.cors.flask_cors import CORS
import json
...
def api_add_user():
    user_info = json.loads(request.headers.get('user_info'))
